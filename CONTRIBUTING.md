...
If a change affects architecture, safety, or scan performance, prefer aligning it with the roadmap first in [ROADMAP.md](/C:/Users/user/Desktop/openpkg/ROADMAP.md).
